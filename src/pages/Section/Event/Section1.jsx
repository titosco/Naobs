...
const Section1 = () => {
  return (
    <div className='grid items-center w-full max-w-6xl mx-auto font-header py-14 lg:py-28'>
        ...
        <span className='text-xs sm:text-sm text-center text-primary mb-2 font-bold'>Spotlight Event</span>
        <div className='grid justify-center bg-chart-5 overflow-hidden shadow-sm mb-4 mx-6 md:mx-12 lg:mx-22 rounded-md h-full relative'>
